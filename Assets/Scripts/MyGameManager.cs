...
// Quaternion is the rotation in relation of object's parent



public static class ApplicationData 
// Vars and objects that can be shared by all scripts
{
    public static bool MakeNewBullet = false;
    public static bool MakeNewTarget = false;
    public static float BulletsFired;
    public static float BulletsMax; // Num of bullets fired
...
public class MyGameManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ApplicationData.BulletsMax = 10;
        //IMPORTANT: bullets available in every round
